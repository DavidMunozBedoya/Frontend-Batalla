...
export default function VerifyPhoneNumber({ phoneNumber = "" }) {
   ...
   return (
      <div className="flex flex-col justify-center items-center text-center p-5 gap-6">
         ...
         <input
            className="border-2 rounded-md border-amber-600 text-xl text-center"
            type="number"
            aria-label="Código de verificación"
         />
         <p>
            Expira en: <strong>00:00</strong>
         </p>
         <Button
